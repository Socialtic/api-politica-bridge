...
write_csv(make_table(party_header, party_data), "dataset/party")
...
write_csv(make_table(contest_header, contest_data), "dataset/contest")
...
write_csv(make_table(profession_header, profession_data), "dataset/profession")
